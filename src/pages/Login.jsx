...
import { loginSlice, clearAuthForce } from '../redux/slices/authSlice';
...
function Login() {
    ...
    const onSubmit = (data) => {
        dispatch(loginSlice(data))
            ...
            .catch((err) => {
                ...
                // Delay 1 detik untuk toast error
                setTimeout(() => {
    ...
    return (
        <div className="font-main relative flex min-h-screen flex-col items-center justify-center px-4 py-8 sm:px-2">
            ...
            <h1 className='text-black font-sans font-extrabold text-4xl mb-2'>ShortLink</h1>
            <main className="md:min-3/6 z-10 w-full max-w-lg rounded-lg bg-white p-8 shadow-lg">
                <section className="text-center md:text-left mb-4">
                    <h1 className="text-black text-display-small-bold">
                        Welcome Back
                    </h1>
